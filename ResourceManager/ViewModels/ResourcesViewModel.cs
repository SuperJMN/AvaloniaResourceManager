...
public class ResourcesViewModel : ViewModelBase, ITitled
{
    ...
    public ResourcesViewModel(ProjectWatcher projectWatcher)
    {
    ...
    {
        return projectWatcher.Resources.Select(list => list.Select(rd => new ResourceDefinitionViewModel(rd)).ToList());
    }
